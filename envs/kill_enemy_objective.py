...
from envs.objectives import TowerfallObjective


class KillEnemyObjective(TowerfallObjective):
  '''
  Specifies observation and rewards associated with killing one slime.
  '''
  def __init__(self,
